...
<body>
	<div id="head-bar">
		...
		<div class="search-bar">
			...
			<?php if(isset($_SESSION['user_login'])== true){
				...
				<button><a href="user_home.php">User profile
				</a></button>';
			}else{
	...
	<section id="image-slider">
		<div class="left-btn">
			<img class="left-slider-button"src="left-button.png" alt="leftbutton">
		</div>
		<div class="image-collector">
			<img src="ps4.jpg" alt="ps4" class="active first">
			<img src="xbox.jpg" alt="xbox">
			<img src="switch.jpg" alt="switch" class="last">
		</div>
		<div class="right-btn">
			<img class="right-slider-button" src="right-button.png" alt="rightbutton">
		</div>
	</section>
				...
				<div class="product-subsection">
					...
					for($j=0;$j<4;$j++):?>
						...
						$product_id = $result[$j]['product_id'];
						 ?>
						<a href="product.php?product_id=<?php echo $product_id; ?>" class="product-subsection-a">
					...
					<?php endfor;?> 
					<span class="view-all"><a href="categories.php?categories_name=<?php echo $session_title[$i] ?>">view all</a></span>
				</div>
			</div>
		<?php endfor;?>
	</section>	
